...
function LoginPageInner() {
  ...
  const errorMessage = errorParam
    ? errorParam === "oauth_not_configured"
      ? "OAuth isn't configured in the local backend yet. Please sign in with email and password."
      : errorParam.startsWith("oauth_")
      ? `Sign in with ${errorParam.replace("oauth_", "").replace("_not_configured", "")} isn't configured yet. Please use email and password.`
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Shield size={14} style={{ color: "var(--primary)", flexShrink: 0 }} aria-hidden="true" />
