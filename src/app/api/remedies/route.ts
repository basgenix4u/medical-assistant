...
const DEFAULT_REMEDIES = [
  {
    ...
    description:
      "Soothing tea for cold, cough, and sore throat. Ginger has anti-inflammatory properties while honey soothes the throat.",
    ingredients: ["Fresh ginger (1 inch)", "Honey (2 tbsp)", "Lemon juice (1 tbsp)", "Hot water (1 cup)"],
    preparation_method:
      "Slice ginger thinly, boil in water for 5-10 minutes. Strain, add honey and lemon when cooled slightly.",
    usage_instructions: "Drink 2-3 cups daily. Best consumed warm.",
    precautions:
      "Avoid if allergic to ginger. Diabetics should limit honey. Not for children under 1 year.",
    remedy_type: "herbal",
  ...
  },
  {
    ...
    description:
      "Anti-inflammatory drink that helps with joint pain, boosts immunity, and aids sleep.",
    ingredients: ["Turmeric powder (1 tsp)", "Milk (1 cup)", "Black pepper (pinch)", "Honey (1 tsp)"],
    preparation_method:
      "Heat milk, add turmeric and black pepper. Simmer for 5 minutes. Add honey after removing from heat.",
    usage_instructions: "Drink once daily, preferably before bed.",
    precautions:
      "May interact with blood thinners. Avoid if you have gallbladder problems.",
  ...
  },
  {
    ...
    preparation_method:
      "Add peppermint to boiling water in a bowl. Create a tent with towel over head.",
  ...
  },
  {
    ...
    name: "Aloe Vera Gel",
    description:
      "Soothes skin rashes, burns, and dry skin. Contains vitamins and anti-inflammatory compounds.",
...
export async function GET(request: NextRequest) {
  ...
  const rl = rateLimit({ key: `remedies:${ip}`, limit: 60, windowMs: 60_000 });
  if (!rl.allowed) {
    return NextResponse.json(
